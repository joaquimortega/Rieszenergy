...
Checked progress: `quadratureError_comp_equiv` and `sobolevWCE_comp_equiv` prove finite relabeling invariance of the actual observable. Harmonic basis existence, evaluation embedding, spectral kernel comparison and universal lower estimates remain open.
