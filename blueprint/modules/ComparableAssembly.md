# Comparable case assembly

All endpoint, equal and adjacent, intermediate, and far comparable blocks satisfy the sharp manuscript estimate for every `0 < α < 2`. The proof combines the exact case split with the unconditional near-tail derivative theorem.
