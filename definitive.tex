...
We have used LLM to refine the computations, revise the correctness of the results and assistance with the Lean formalization. The authors take responsibility of all the content.

The Lean formalization is available at the GitHub repository:
\href{https://github.com/joaquimortega/Rieszenergy}{Rieszenergy}.
